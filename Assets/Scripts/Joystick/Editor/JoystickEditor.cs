...
public class JoystickEditor : Editor
{
    ...
    private SerializedProperty inputTypes;
    ...
    protected virtual void OnEnable()
    {
        ...
        inputTypes = serializedObject.FindProperty("inputTypes");
    ...
    protected virtual void DrawValues()
    {
        ...
        EditorGUILayout.PropertyField(inputTypes, new GUIContent("Input Types"));
        ...
        EditorGUILayout.PropertyField(targetObj, new GUIContent("Target"));
    }
